-- forked from https://github.com/sindrets/dotfiles/blob/d9cd3a1f1ad48c4c4ac26320a238df103bfcaded/.config/nvim/lua/user/plugins/fugitive.lua
local M = {
...
vim.api.nvim_create_autocmd("FileType", {
  ...
  callback = function(ctx)
    vim.print("Fugitive keymap setting")
